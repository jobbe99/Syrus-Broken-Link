...
<div class="search-box">
	...
	<form name="save-search-query" id="custom-filter-form" action="<?php echo admin_url("tools.php?page=view-broken-links");  ?>" method="post" class="blc-inline-form">
		...
		<input type="button" value="<?php esc_attr_e( 'Save This Search As a Filter', 'syrus-link-checker' ); ?>" id="blc-create-filter" class="button" />
	</form>				 				
	<?php
	...
	<form name="save-search-query" id="custom-filter-form" action="<?php echo admin_url("tools.php?page=view-broken-links");  ?>" method="post" class="blc-inline-form">
		...
		<input type="submit" value="<?php esc_attr_e( 'Delete This Filter', 'syrus-link-checker' ); ?>" id="blc-delete-filter" class="button" />
	</form>
	<?php
			}
	?>
	
	<input type="button" value="<?php esc_attr_e( 'Search', 'syrus-link-checker' ); ?> &raquo;" id="blc-open-search-box" class="button" />
</div>
...
<form class="search-form" action="<?php echo admin_url('tools.php?page=view-broken-links'); ?>" method="get">
	...
	<label for="s_link_text"><?php _e('Link text', 'syrus-link-checker'); ?></label>
	...
	<label for="s_link_url"><?php _e('URL', 'syrus-link-checker'); ?></label>
	...
	<label for="s_http_code"><?php _e('HTTP code', 'syrus-link-checker'); ?></label>
	...
	<label for="s_filter"><?php _e('Link status', 'syrus-link-checker'); ?></label>
	...
	<label for="s_link_type"><?php _e('Link type', 'syrus-link-checker'); ?></label>
	<select name="s_link_type" id="s_link_type">
		<option value=""><?php _e('Any', 'syrus-link-checker'); ?></option>
		<?php
		$moduleManager = blcModuleManager::getInstance();
		
		printf('<optgroup label="%s">', esc_attr(__('Links used in', 'syrus-link-checker')));
		...
		printf('<optgroup label="%s">', esc_attr(__('Link type', 'syrus-link-checker')));
		...
		/*
		$link_types = array(
			__('Any', 'syrus-link-checker') => '',
			__('Normal link', 'syrus-link-checker') => 'link',
			__('Image', 'syrus-link-checker') => 'image',
			__('Custom field', 'syrus-link-checker') => 'custom_field',
			__('Bookmark', 'syrus-link-checker') => 'blogroll',
			__('Comment', 'syrus-link-checker') => 'comment',
		);
		*/
		?>
	</select>
	...
	<div id="blc-search-button-row">
		<input type="submit" value="<?php esc_attr_e( 'Search Links', 'syrus-link-checker' ); ?>" id="blc-search-button" name="search_button" class="button-primary" />
		<input type="button" value="<?php esc_attr_e( 'Cancel', 'syrus-link-checker' ); ?>" id="blc-cancel-search" class="button" />
	</div>
