...
/**
* Display a notice asking the user to take the Syrus Link Checker user survey.
*
* @return void
*/
function blc_display_survey_notice(){
	...
	$msg = sprintf(
		'<strong>Help improve Syrus Link Checker - <a href="%s" target="_blank" title="This link will open in a new window" id="blc-take-survey-link">take a user feedback survey!</a></strong>
