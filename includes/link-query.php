...
class blcLinkQuery {
	...
	function __construct(){
		...
		$this->native_filters = array(
			'all' => array(
				...
				'name' => __('All', 'syrus-link-checker'),
				'heading' => __('Detected Links', 'syrus-link-checker'),
				'heading_zero' => __('No links found (yet)', 'syrus-link-checker'),
				'native' => true,
			),
			...
			'broken' => array(
				...
				'name' => __('Broken', 'syrus-link-checker'),
				'heading' => __('Broken Links', 'syrus-link-checker'),
				'heading_zero' => __('No broken links found', 'syrus-link-checker'),
				'native' => true,
			),
			'warnings' => array(
				'params' => array(
				...
				'name' => _x('Warnings', 'filter name', 'syrus-link-checker'),
				'heading' => __('Warnings', 'filter heading', 'syrus-link-checker'),
				'heading_zero' => __('No warnings found', 'syrus-link-checker'),
				'native' => true,
			),
			'redirects' => array(
				'params' => array(
				...
				'name' => __('Redirects', 'syrus-link-checker'),
				'heading' => __('Redirected Links', 'syrus-link-checker'),
				'heading_zero' => __('No redirects found', 'syrus-link-checker'),
				'native' => true,
			),
			...
			'dismissed' => array(
				...
				'name' => __('Dismissed', 'syrus-link-checker'),
				'heading' => __('Dismissed Links', 'syrus-link-checker'),
				'heading_zero' => __('No dismissed links found', 'syrus-link-checker'),
				'native' => true,
			),
		);
		...
		$this->search_filter = array(
			'name' => __('Search', 'syrus-link-checker'),
			'heading' => __('Search Results', 'syrus-link-checker'),
			'heading_zero' => __('No links found for your query', 'syrus-link-checker'),
			'params' => array(),
			'use_url_params' => true,
			'hidden' => true,
		);
   ...
   */
	function get_links($params = null){
		...
		//Join the syrus_link_checker_instances table if it's required to perform the search.  
		$joins = "";
		if ( $criteria['join_instances'] ){
			$joins = "JOIN {$wpdb->prefix}syrus_link_checker_instances AS instances ON links.link_id = instances.link_id";
		}
