...
class blcEmbedParserBase extends blcParser {
   ...
   */
	...
	function edit($content, $new_url, $old_url, $old_raw_url){
		return new WP_Error(
			'not_implemented',
			sprintf(__("Embedded videos can't be edited using Syrus Link Checker. Please edit or replace the video in question manually.", 'syrus-link-checker'), $this->parser_type)
		);
	}
